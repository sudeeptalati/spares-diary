...
class InstallController extends Controller
{
	...
	private function createTables()
	{
		...
		catch(Exception $e)
		{
			...
			throw new CHttpException (500, Yii::t('userGroupsModule.install', 'Unable to create the tables in the database. Make sure that your db user has the necessary permissions to create a new table.<br/>This release only officially supports Mysql and PostgreSQL.  THE DRIVER NAME IS '.$driver));
			return false;
		}*/
	}
